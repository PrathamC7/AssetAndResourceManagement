        ...
        <aside className={`fixed inset-y-0 left-0 z-50 w-72 bg-white text-slate-700 flex flex-col p-6 transition-transform duration-300 transform md:relative md:translate-x-0 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} border-r border-slate-200`}>
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-3 py-3 rounded-lg text-sm font-semibold transition-all text-left ${isActive ? 'bg-slate-100 text-slate-950 font-bold border-l-4 border-slate-950' : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50'}`}
                >
          ...
          <div className="mt-auto pt-6 border-t border-slate-200 flex flex-col gap-3">
            ...
            <button 
              ...
              className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg border border-slate-200 text-slate-500 hover:text-slate-800 hover:bg-slate-50 transition-colors text-xs font-semibold"
            >
